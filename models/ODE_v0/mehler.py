...
def add_mehler(m) -> Model:
    ...
    m.add_reaction(
        ...
        stoichiometry={
            ...
            # "P700+FA": +1, # is a derived compound! # should also be +2 (see below)
            "P700+FA-": -1 # to be consistent with the prior model, this stoichiometry is not used. but #! it is wrong, it should be -2
        },  
